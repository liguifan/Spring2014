...
//            s3.putObject(new PutObjectRequest(bucketName, key, createSampleFile()));
            s3.putObject(new PutObjectRequest(bucketName, key,
            			 new File("/Users/liguifan/Desktop/music/IMG_0155.MOV"))
...
//            s3.deleteBucket(bucketName);
            ...
            String input_database="insert into video_info values("+key+","+url_link+")";
            
            
            System.out.println(input_database);
//            myAmazonS3Client.putObject(new PutObjectRequest(bucketName, key, new File('/Users/ben/Desktop/photo.jpg')).withCannedAcl(CannedAccessControlList.PublicRead))
