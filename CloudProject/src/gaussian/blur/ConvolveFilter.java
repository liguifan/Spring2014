...
public class ConvolveFilter extends AbstractBufferedImageOp {
	...
	public static void main(String args[]) throws IOException{
		...
		BufferedImage image=getImg("AB.jpg");
		BufferedImage image2=getImg("1.jpg");
		ConvolveFilter BB=new ConvolveFilter();
		BufferedImage imageA=BB.filter(image,image2);
