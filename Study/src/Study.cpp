...
int main(){
	 ...
	 ifstream reader("/Users/liguifan/Desktop/data/ccc.txt");
	 //reader.open ("/Users/liguifan/Desktop/data/ccc.txt");
	 //reader << "Writing this to a file.\n";
	 ...
	 while (!reader.eof())
	 {
		 ...
		 int y_original=(int) tempstr(0)-48;
